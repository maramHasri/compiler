...
public interface MyGrammarParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterElementContent(MyGrammarParser.ElementContentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ElementContent}
	 * labeled alternative in {@link MyGrammarParser#content}.
	 * @param ctx the parse tree
	 */
	void exitElementContent(MyGrammarParser.ElementContentContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterNormalElement(MyGrammarParser.NormalElementContext ctx);
	/**
	 * Exit a parse tree produced by the {@code NormalElement}
	 * labeled alternative in {@link MyGrammarParser#element}.
	 * @param ctx the parse tree
	 */
	void exitNormalElement(MyGrammarParser.NormalElementContext ctx);
	/**
